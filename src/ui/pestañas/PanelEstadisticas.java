...
public class PanelEstadisticas extends JPanel {
    ...
    public PanelEstadisticas() {
        ...
        lblIngresos = new JLabel("", SwingConstants.CENTER);
        ...
        pnlGrafico.setPreferredSize(new Dimension(800, 450));
        pnlGrafico.setMaximumSize(new Dimension(1400, 600));
    ...
    private JPanel crearCard(String titulo, JLabel lblValor, Color colorAcento) {
        ...
        lblTit.setBorder(BorderFactory.createEmptyBorder(10,0,0,0));
